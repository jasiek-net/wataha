...
<head>
  <title>Wataha Tech Team</title>
    ...
    <meta property="og:title" content="PhotoSwipe Options" />
    <meta property="twitter:title" content="PhotoSwipe Options" />
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">getThumbBoundsFn</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">index</span><span class="p">)</span> <span class="p">{</span>
...
<div class="language-css highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nc">.pswp--animate_opacity</span><span class="o">,</span>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">getDoubleTapZoom</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">isMouseClick</span><span class="p">,</span> <span class="nx">item</span><span class="p">)</span> <span class="p">{</span>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="nx">isClickableElement</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">el</span><span class="p">)</span> <span class="p">{</span>
...
<div class="language-javascript highlighter-rouge"><div class="highlight"><pre class="highlight"><code><span class="c1">// Size of top &amp; bottom bars in pixels,</span>
...
<span class="nx">barsSize</span><span class="p">:</span> <span class="p">{</span><span class="nl">top</span><span class="p">:</span><span class="mi">44</span><span class="p">,</span> <span class="nx">bottom</span><span class="p">:</span><span class="s1">'auto'</span><span class="p">},</span> 

<span class="c1">// Adds class pswp__ui--idle to pswp__ui element when mouse isn't moving for 4000ms</span>
<span class="nx">timeToIdle</span><span class="p">:</span> <span class="mi">4000</span><span class="p">,</span>

<span class="c1">// Same as above, but this timer applies when mouse leaves the window</span>
<span class="nx">timeToIdleOutside</span><span class="p">:</span> <span class="mi">1000</span><span class="p">,</span>

<span class="c1">// Delay until loading indicator is displayed</span>
<span class="nx">loadingIndicatorDelay</span><span class="p">:</span> <span class="mi">1000</span><span class="p">,</span>

<span class="c1">// Function builds caption markup</span>
<span class="nx">addCaptionHTMLFn</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">item</span><span class="p">,</span> <span class="nx">captionEl</span><span class="p">,</span> <span class="nx">isFake</span><span class="p">)</span> <span class="p">{</span>
...
<span class="nx">closeEl</span><span class="p">:</span><span class="kc">true</span><span class="p">,</span>
<span class="nx">captionEl</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
<span class="nx">fullscreenEl</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
<span class="nx">zoomEl</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
<span class="nx">shareEl</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
<span class="nx">counterEl</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
<span class="nx">arrowEl</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
<span class="nx">preloaderEl</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>

<span class="c1">// Tap on sliding area should close gallery</span>
<span class="nx">tapToClose</span><span class="p">:</span> <span class="kc">false</span><span class="p">,</span>

<span class="c1">// Tap should toggle visibility of controls</span>
<span class="nx">tapToToggleControls</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
...
<span class="nx">clickToCloseNonZoomable</span><span class="p">:</span> <span class="kc">true</span><span class="p">,</span>
...
<span class="nx">closeElClasses</span><span class="p">:</span> <span class="p">[</span><span class="s1">'item'</span><span class="p">,</span> <span class="s1">'caption'</span><span class="p">,</span> <span class="s1">'zoom-wrap'</span><span class="p">,</span> <span class="s1">'ui'</span><span class="p">,</span> <span class="s1">'top-bar'</span><span class="p">],</span> 

<span class="c1">// Separator for "1 of X" counter</span>
<span class="nx">indexIndicatorSep</span><span class="p">:</span> <span class="s1">' / '</span><span class="p">,</span>
...
<span class="nx">shareButtons</span><span class="p">:</span> <span class="p">[</span>
...
<span class="nx">getImageURLForShare</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span> <span class="nx">shareButtonData</span> <span class="p">)</span> <span class="p">{</span>
...
<span class="p">},</span>
<span class="nx">getPageURLForShare</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span> <span class="nx">shareButtonData</span> <span class="p">)</span> <span class="p">{</span>
...
<span class="p">},</span>
<span class="nx">getTextForShare</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span> <span class="nx">shareButtonData</span> <span class="p">)</span> <span class="p">{</span>
...
<span class="nx">parseShareButtonOut</span><span class="p">:</span> <span class="kd">function</span><span class="p">(</span><span class="nx">shareButtonData</span><span class="p">,</span> <span class="nx">shareButtonOut</span><span class="p">)</span> <span class="p">{</span>
	<span class="c1">// `shareButtonData` - object from shareButtons array</span>
